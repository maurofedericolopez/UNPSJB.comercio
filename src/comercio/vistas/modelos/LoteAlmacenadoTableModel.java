 ...
 */
public class LoteAlmacenadoTableModel extends AbstractTableModel implements Observer {

    private String[] columnsNames = {"Código","Producto","Cantidad","Sucursal","Almacén"};
    private LotesController controlador;
    private ArrayList<LoteAlmacenado> lotes;

    public LoteAlmacenadoTableModel() {
        super();
        controlador = new LotesController();
        controlador.addObserver(this);
        lotes = controlador.obtenerLotesAlmacenados();
    }
